...
def test_implicit_waits_test(driver):
    # Переход по URL
    ...
    # Ожидание всех элементов будет применено автоматически 6 сек согласно driver.
    # Найти кнопку "Начать тестирование".
    ...
    driver.find_element(By.ID, "loader").is_displayed()
